<template>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="flex-1 flex items-center space-x-2">
                        <h5>
                            <span class="text-gray-500">{{$lang('LBL_ALL_CUSTOMER')}}: </span>
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" placeholder="Search for Cutomers" required="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            </div>
                        </form>
                    </div>
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <button type="button" id="createCutomerButton" data-modal-target="create-Cutomer-modal" data-modal-toggle="create-Cutomer-modal" class="flex items-center justify-center text-white bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-primary-800">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="p-4">Cutomer</th>
                        ...
                        >
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center space-x-3 justify-end">
                                    <button type="button" @click="openUpdateModal(item.id)" data-drawer-target="drawer-update-customer" data-drawer-show="drawer-update-customer"  class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-blue-600 dark:focus:ring-primary-800">
                        ...
                        <tr v-if="store.getters['Cutomers/isLoading']">
                            <td colspan="8" class="p-4 text-center">Loading...</td>
                        </tr>
                        <tr v-if="!store.getters['Cutomers/isLoading'] && list.length === 0">
    ...
    <!-- End block -->
    <div id="create-Cutomer-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-999 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] md:h-full">
        <div class="relative p-4 w-full max-w-3xl h-full md:h-auto z-9999">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <!-- Modal header -->
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Cutomer</h3>
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="create-Cutomer-modal">
                ...
                <!-- Modal body -->
                <form @submit.prevent="handleCreateCutomer">
                    ...
                    <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <button type="submit" class="w-full sm:w-auto justify-center text-white inline-flex bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-blue-600 dark:focus:ring-primary-800">Add customer</button>
                        <button data-modal-toggle="create-customer-modal" type="button" class="w-full justify-center sm:w-auto text-gray-500 inline-flex items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
    ...
    <!-- drawer component -->
    <form action="#" id="drawer-update-customer" class="fixed top-0 left-0 z-999 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-customer-label" aria-hidden="true">
        <h5 id="drawer-label" class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Edit Cutomer</h5>
        <button type="button" data-drawer-dismiss="drawer-update-customer" aria-controls="drawer-update-customer" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
            </svg>
        ...
        <div class="relative w-full h-auto max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this Cutomer?</h3>
...
// Fetch Cutomers data from Vuex store
...
// Handle create Cutomer
const handleCreateCutomer = async () => {
    try {
        await store.dispatch('customers/createCutomer', { ...form });
        notify({
            group: "foo",
            title: "Success",
            text: "Cutomer created successfully!",
        }, 4000);
        resetForm();
        fetchData(); // Refresh the list after creating an customer
    } catch (error) {
        notify({
            group: "foo",
            title: "Error",
...
// Handle update Cutomer
const handleUpdateCutomer = async () => {
    try {
        await store.dispatch('Cutomers/updateCutomer', {
            id: formEdit.id,
            customerData: { ...formEdit },
        });
        notify({
            group: "foo",
            title: "Success",
            text: "Cutomer updated successfully!",
        }, 4000);
        fetchData();
...
const openUpdateModal = (customer) => {
    ...
    formEdit.city = customer.city;
    formEdit.state = customer.state;
    formEdit.ward = customer.ward;
    formEdit.description = customer.description;
...
// Delete Cutomer
const handleDeleteCutomer = async (id) => {
    try {
        await store.dispatch('Cutomers/deleteCutomer', id);
        notify({
            group: "foo",
            title: "Success",
            text: "Cutomer deleted successfully!",
        }, 4000);
        fetchData();
...
onMounted(() => {
    ...
    const $updateDrawer = document.getElementById('drawer-update-customer');
