<template>
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" placeholder="Search for teams" required=""
                    ...
                    <div
                        ...
                        <button v-show="store.getters.hasPermission({'module': moduleName, 'action': 'create'})"
                                type="button" id="createteamButton" data-modal-target="create-team-modal"
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center space-x-3 justify-end">
                                    <button
                                        ...
                                        data-drawer-target="drawer-update-team" data-drawer-show="drawer-update-team"
                ...
                <form @submit.prevent="handleCreateTeam">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-1">
                            <div>
                                ...
                                <input v-model="form.name" type="text" name="name" id="name"
                                       ...
                                       placeholder="Type team name" required="">
                            </div>
                            <div>
                                <label for="adress"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                                <input v-model="form.address" type="text" name="brand" id="brand"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                       placeholder="Team Address" required="">
                            </div>
                        </div>
                        <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                <label
                                    class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Province</label>
                                <select v-model="form.city" @change="form.district = ''; form.ward = ''"
                            ...
                            <div>
                                <label
                                    class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">District</label>
                                <select v-model="form.state" @change="form.ward = ''"
                                        class="bg-white border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <div class="sm:col-span-2"><label for="description"
                            ...
                            placeholder="Write team description here"></textarea>
                        </div>
                    </div>
                    <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        ...
                        <button data-modal-toggle="create-team-modal" type="button"
    ...
    <!-- drawer component -->
    <form action="#" id="drawer-update-team"
          ...
          tabindex="-1" aria-labelledby="drawer-update-team-label" aria-hidden="true">
        <h5 id="drawer-label"
            class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Edit
            team</h5>
        <button type="button" data-drawer-dismiss="drawer-update-team" aria-controls="drawer-update-team"
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-1">
                    ...
                    <div>
                        <label for="adress"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                        <input v-model="formEdit.address" type="text" name="brand" id="brand"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                               placeholder="Team Address" required="">
                    </div>
                </div>
                <div class="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <input v-model="formEdit.ward" type="text" name="price" id="price"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div>
                        ...
                        <input v-model="formEdit.state" type="text" name="brand" id="brand"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div>
                        ...
                        <input v-model="formEdit.city" type="text" name="price" id="price"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                ...
                <div class="sm:col-span-2"><label for="description"
                    ...
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Write team description here"></textarea></div>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
            <button @click="updateTeam" type="submit"
            ...
            <button @click="deletTeam" type="button"
...
const provinces = ref([]); // Reactive state for drawer visibility
const districts = ref([]); // Reactive state for drawer visibility
const wards = ref([]); // Reactive state for drawer visibility
...
const handleCreateTeam = async () => {
    try {
        await store.dispatch('teams/createTeam', form.value);
        notify({
            group: "foo",
            title: "Success",
...
const filteredDistricts = computed(() => {
    ...
    return districts.value.filter(d => d.ProvinceID.toString() === form.value.city.toString());
});
watch(() => form.value.state, (newDistrictId) => {
    if (newDistrictId) {
