<template>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        >
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center space-x-3 justify-end">
                                    <button type="button" @click="openUpdateModal(item.id)" data-drawer-target="drawer-update-employee" data-drawer-show="drawer-update-employee"  class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-blue-600 dark:focus:ring-primary-800">
                        ...
                        <tr v-if="store.getters['Employees/isLoading']">
                            <td colspan="8" class="p-4 text-center">Loading...</td>
                        </tr>
                        <tr v-if="!store.getters['Employees/isLoading'] && list.length === 0">
    ...
    <form action="#" id="drawer-update-employee" class="fixed top-0 left-0 z-999 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-employee-label" aria-hidden="true">
        <h5 id="drawer-label" class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Edit Employee</h5>
        ...
        <div class="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
            <button @click="updateEmployee" type="submit" class="text-white bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-blue-600 dark:focus:ring-primary-800">Update Employee</button>
            <button @click="deletEmployee" type="button" class="text-red-600 inline-flex justify-center items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
...
// Fetch Employees data from Vuex store
const fetchData = async () => {
    try {
        await store.dispatch('employees/fetchEmployees');
        debugger
        list.value = store.state.employees.employees; // Adjusted based on the store state
    } catch (error) {
...
const handleCreateEmployee = async () => {
    try {
        await store.dispatch('employees/createEmployee', { ...form });
        notify({
            group: "foo",
            title: "Success",
        ...
        resetForm();
        fetchData(); // Refresh the list after creating an employee
    } catch (error) {
        notify({
            group: "foo",
            title: "Error",
...
const openUpdateModal = (employee) => {
    formEdit.id = employee.id;
    formEdit.name = employee.name;
    formEdit.address = employee.address;
    formEdit.city = employee.city;
    formEdit.state = employee.state;
    formEdit.ward = employee.ward;
    formEdit.description = employee.description;
...
onMounted(() => {
    ...
    const $updateDrawer = document.getElementById('drawer-update-employee');
