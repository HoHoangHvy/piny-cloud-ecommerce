<template>
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" placeholder="Search for Employees" required=""
    ...
    <!-- End block -->
    <div id="create-Employee-modal" tabindex="-1" aria-hidden="true"
                ...
                <form @submit.prevent="handleCreateEmployee">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <select v-model="form.team_id" id="team_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                                <option v-for="team in store.getters['teams/allTeamsOption']" :value="team.id"
                        ...
                        <div>
                            ...
                            <select v-model="form.role_id" id="team_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                                <option v-for="role in store.getters['roles/allRolesOptions']" :value="role.id"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.level" type="text" id="level"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div>
                            <label for="date_registered"
                                ...
                                Registered</label>
                            <input v-model="form.date_registered" type="date" id="date_registered"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                   required>
                        </div>
                    </div>
    ...
    <!-- drawer component -->
    <form action="#" id="drawer-update-employee"
          ...
          tabindex="-1" aria-labelledby="drawer-update-employee-label" aria-hidden="true">
        <h5 id="drawer-label"
            class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Edit
            Employee</h5>
        <button type="button" data-drawer-dismiss="drawer-update-employee" aria-controls="drawer-update-employee"
        ...
        <div class="grid gap-4 sm:grid-cols-1 sm:gap-6 ">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2"><label for="description"
                    ...
                    placeholder="Write Employee description here"></textarea></div>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
            <button @click="updateEmployee" type="submit"
            ...
            <button @click="deletEmployee" type="button"
...
const fetchOptions = async () => {
    try {
        ...
        await store.dispatch('roles/fetchRoleOptions');
    } catch (error) {
...
const handleCreateEmployee = async () => {
    try {
        let result = await store.dispatch('employees/createEmployee', {...form});
        if(!store.getters["employees/error"]) {
            resetForm();
