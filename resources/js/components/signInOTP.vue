            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="handleSignIn">
                        ...
                        <div>
                            <!-- Trong SignInOTP.vue -->
                            <a @click.prevent="$emit('toggle')" class="text-sm font-inter text-black dark:text-gray-400 hover:underline">
                                {{ t('LBL_OR_LOGIN_WITH_PASSWORD') }}
                            </a>

<!--                            <a href="http://127.0.0.1:8000/sign-in-password" class="text-sm font-inter text-black dark:text-gray-400 hover:underline">{{ t('LBL_OR_LOGIN_WITH_PASSWORD') }}</a>-->
                        </div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="http://127.0.0.1:8000/sign-up" class="hover:underline font-inter text-[#4D2F19]" target="_parent">{{ t('LBL_SIGNUP') }}</a>
                        </div>
                    </form>
                </div>
            </div>
