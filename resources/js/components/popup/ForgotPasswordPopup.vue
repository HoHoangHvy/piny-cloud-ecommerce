                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <div v-if="step === 1">
                            ...
                            <button @click="sendCode"
                                    class="w-full text-white bg-[#4D2F19] hover:bg-[#4D2F19] font-inter rounded-lg  px-5 py-2.5 mt-4">
                                {{ t('LBL_SEND_CODE') }}
                            </button>
                        </div>
                        ...
                        <div v-else-if="step === 2">
                            ...
                            <button @click="verifyCode"
                                    class="w-full text-white bg-[#4D2F19] hover:bg-[#4D2F19]  font-inter rounded-lg text-sm px-5 py-2.5 mt-4">
                                {{ t('LBL_VERIFY_CODE') }}
                            </button>
                        </div>
