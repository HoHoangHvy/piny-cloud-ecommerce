                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="input-container">
                            <label for="password" class="block mb-2 text-sm font-inter text-black dark:text-white">{{ t('LBL_PASSWORD') }}</label>
                        ...
                        <div>
                            <a href="http://127.0.0.1:8000/sign-in/forgot-password" class="hover:underline text-sm font-inter text-black dark:text-blue-400 hover:underline" target="_parent">{{ t('LBL_FORGOT_PASSWORD?') }}</a>
                        </div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="http://127.0.0.1:8000/sign-up" class="hover:underline text-[#4D2F19]" target="_self">{{ t('LBL_SIGNUP') }}</a>
                        </div>
                    </form>
                    ...
                    <div class="flex space-x-1">
                        ...
                        <button @click="$emit('toggle')" class="text-sm font-inter text-black dark:text-blue-400 hover:underline">
